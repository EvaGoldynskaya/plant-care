import { Button, Flex, Form, Radio, Select, Space, Tag } from 'antd';
import { plantActionType, type PlantActionRequest } from '../../../types/plant.types';
...
export default function PlantActionButtons({ plantId, onAction }: PlantActionButtonsProps) {
    ...
    <Form form={form} onFinish={handleAction}>
      <Space align="end" size="middle">
        <Space orientation="vertical" size="small">
          ...
          <Form.Item  name="type" rules={[{ required: true, message: 'Выберите тип действия' }]} noStyle>
            <Radio.Group
              optionType="button" 
              vertical
              options={Object.entries(plantActionType).map(([key, value]) => ({
                  label: value,
                  value: value,
              }))}
            >
