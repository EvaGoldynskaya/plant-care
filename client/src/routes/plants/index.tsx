...
import { Button, Card, Empty, Flex, Listy, Space, Spin, Typography, message } from 'antd';
            ...
            <Flex gap="middle" align="flex-start">
                <Flex vertical flex="auto" style={{ minWidth: 0 }}>
                  ...
                  <Flex justify="left" gap="small">
                    <Typography.Text type="secondary">{item.commonName}</Typography.Text>
                    {item.lastAction?.createdAt && (
                      <Typography.Text type="secondary">Последний полив: {formatDate(item.lastAction.createdAt)}</Typography.Text>
                    )}
                  </Flex>
                </Flex>
            </Flex>
