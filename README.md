...
Приложение поднято на vercel, посмотреть можно тут https://plant-care-pearl.vercel.app/
Там оно работает помедленнее т.к. бд не локальная, а бесплатная на сервере prisma.
Так же бывает 404, которая не появляется локально, пока неизвестно с чем связана, но чинится перезаходом в профиль и несколькими перезагрузками страницы.